  ...
  return (function (t) {
    ...
    1: function (t, e, o) {
      ...
      e.a = {
        create: (t, e) =>
          function () {
            const o =
              "object" == typeof arguments[1] ? arguments[1] : arguments[0];
    ...
    3: function (t, e, o) {
          ...
          return t.length
            ? C(t).reduce(
                function (t, o) {
                  const i = k(t);
                  return (
                    e(k(i), o) ? (i[i.length] = o) : (t[t.length] = [o]), t
                  );
                },
                [[v(t)]]
              )
      ...
      function W(t) {
        ...
        return (
          0 === e ||
          (!T(t) && 1 === e && t.innerHTML === j) ||
          !(!w.all(t.childNodes, T) || "" !== t.innerHTML)
        );
      }
      function V(t) {
      ...
      function nt(t, e) {
        ...
        if (0 === t.offset) {
          ...
          it(t.node)
            ? (i = K((o = t.node.childNodes[t.offset - 1])))
      ...
      function st(t, e) {
        ...
        if (K(t.node) === t.offset) {
          ...
          it(t.node)
            ? ((o = t.node.childNodes[t.offset]), (i = 0))
            : ((o = t.node), (i = e ? K(t.node) : t.offset + 1));
        return { node: o, offset: i };
      }
      function rt(t, e) {
      ...
      function at(t, e) {
        ...
        if (T(t.node)) return t.node.splitText(t.offset);
        {
          ...
          return (
            Q(i, G(e)),
            o || (V(t.node), V(i)),
            n && (W(t.node) && ht(t.node), W(i))
              ? (ht(i), t.node.nextSibling)
              : i
          );
        }
      }
      ...
      var pt = {
        ...
        walkPoint: function (t, e, o, i) {
          let n = t;
          for (; n && (o(n), !rt(n, e)); )
            n = st(n, i && t.node !== n.node && e.node !== n.node);
        },
        ancestor: q,
        ...
        splitPoint: function (t, e) {
          ...
          let a =
            s &&
            lt(s, t, { isSkipPaddingBlankHTML: e, isNotSplitEdgePoint: e });
          return (
      ...
      function gt(t) {
        const e = function (t, o) {
            ...
            if (pt.isText(t)) {
              ...
              (i = s || t.parentNode),
                (o += w.sum(w.tail(e), pt.nodeLength)),
                (n = !s);
            } else {
          ...
          (i.langInfo = n.a.extend(
            ...
            this.each((t, e) => {
              ...
              if (!o.data("summernote")) {
                const t = new mt(o, i);
                o.data("summernote", t),
                  o.data("summernote").triggerEvent("init", t.layoutInfo);
              }
            });
          const s = this.first();
          if (s.length) {
      ...
      class bt {
        ...
        nativeRange() {
          ...
          {
            const t = gt({ node: this.sc, offset: this.so });
            return (
              t.setEndPoint("EndToEnd", gt({ node: this.ec, offset: this.eo })),
              t
            );
          }
        }
          ...
          const t = function (t, e) {
              ...
              if (
                ((pt.isLeftEdgePointOf(t, o) ||
                  pt.isVoid(pt.prevPoint(t).node)) &&
                  !e) ||
                ((pt.isRightEdgePointOf(t, o) ||
                  pt.isVoid(pt.nextPoint(t).node)) &&
                  e)
              ) {
          ...
          return (
            pt.walkPoint(
              ...
              function (e) {
                ...
                let n;
                i
                  ? (pt.isLeftEdgePoint(e) && a.push(e.node),
                    pt.isRightEdgePoint(e) &&
                      w.contains(a, e.node) &&
                      (n = e.node))
                  : (n = o ? pt.ancestor(e.node, t) : e.node),
                  n && t(n) && r.push(n);
              },
              !0
            ),
        ...
        expand(t) {
          ...
          return (
            ...
            new bt(i.sc, i.so, i.ec, i.eo)
          );
        }
        collapse(t) {
          return t
            ? new bt(this.sc, this.so, this.sc, this.so)
            : new bt(this.ec, this.eo, this.ec, this.eo);
        }
        splitText() {
        ...
        deleteContents() {
          ...
          return (
            n.a.each(e, function (t, e) {
              ...
              o.node !== n && 1 === pt.nodeLength(n) && i.push(n),
                pt.remove(e, !1);
            }),
        ...
        wrapBodyInlineWithPara() {
          if (pt.isBodyContainer(this.sc) && pt.isEmpty(this.sc))
            return (
              ...
              new bt(this.sc.firstChild, 0, this.sc.firstChild, 0)
            );
          ...
          if (pt.isInline(t.sc)) {
            ...
            (e = w.last(o)),
              pt.isInline(e) || (e = o[o.length - 2] || t.sc.childNodes[t.so]);
          } else e = t.sc.childNodes[t.so > 0 ? t.so - 1 : 0];
          let o = pt.listPrev(e, pt.isParaInline).reverse();
          if (
            (o = o.concat(pt.listNext(e.nextSibling, pt.isParaInline))).length
          ) {
        ...
        getWordRange(t) {
          ...
          return (
            t &&
              (e = pt.nextPointUntil(e, function (t) {
                return !pt.isCharPoint(t);
              })),
      ...
      var vt = {
        create: function (t, e, o, i) {
          ...
          if (2 === arguments.length) return new bt(t, e, (o = t), (i = e));
          {
            ...
            return t || 1 !== arguments.length
              ? t
              : (t = this.createFromNode(arguments[0])).collapse(
        ...
        createFromSelection: function () {
          ...
          if (f.isW3CRangeSupport) {
            ...
            let a = ft(r, !0),
              l = ft(s, !1);
            pt.isText(a.node) &&
              pt.isLeftEdgePoint(a) &&
              pt.isTextNode(l.node) &&
              pt.isRightEdgePoint(l) &&
        ...
        createFromNode: function (t) {
          ...
          return (
            ...
            pt.isBR(i)
              ? ((n = pt.listPrev(i).length - 1), (i = i.parentNode))
              : pt.isVoid(i) &&
                ((n = pt.listPrev(i).length), (i = i.parentNode)),
            this.create(e, o, i, n)
          );
        },
      ...
      var Ct = {
        isEdit: (t) =>
          w.contains([kt.BACKSPACE, kt.TAB, kt.ENTER, kt.SPACE, kt.DELETE], t),
      ...
      class yt {
        ...
        applySnapshot(t) {
          null !== t.contents && this.$editable.html(t.contents),
            null !== t.bookmark &&
              vt.createFromBookmark(this.editable, t.bookmark).select();
        }
        rewind() {
      ...
      class wt {
        ...
        stylePara(t, e) {
          n.a.each(t.nodes(pt.isPara, { includeAncestor: !0 }), (t, o) => {
            n()(o).css(e);
          });
        }
        styleNodes(t, e) {
      ...
      class xt {
        ...
        indent(t) {
          const e = vt.create(t).wrapBodyInlineWithPara(),
            o = e.nodes(pt.isPara, { includeAncestor: !0 }),
        ...
        toggleList(t, e) {
          ...
          let i = o.nodes(pt.isPara, { includeAncestor: !0 });
        ...
        wrapList(t, e) {
          ...
          return (
            (t = t.map((t) => (pt.isPurePara(t) ? pt.replace(t, "LI") : t))),
            pt.appendChildNodes(r, t),
            s && (pt.appendChildNodes(r, w.from(s.childNodes)), pt.remove(s)),
            t
          );
        }
        releaseList(t, e) {
              ...
              if ("LI" === a.parentNode.nodeName)
                ...
                const t =
                    a.childNodes.length > 1
                      ? pt.splitTree(
                          a,
                          { node: r.parentNode, offset: pt.position(r) + 1 },
                          { isSkipPaddingBlankHTML: !0 }
                        )
                      : null,
                  o = pt.splitTree(
                    a,
                    { node: s.parentNode, offset: pt.position(s) },
                    { isSkipPaddingBlankHTML: !0 }
                  );
                (i = e
                  ? pt.listDescendant(o, pt.isLi)
                  : w.from(o.childNodes).filter(pt.isLi)),
                  (!e && pt.isList(a.parentNode)) ||
                    (i = i.map((t) => pt.replace(t, "P"))),
                  n.a.each(w.from(i).reverse(), (t, e) => {
                    pt.insertAfter(e, a);
                  });
        ...
        findList(t) {
          return t
            ? w.find(t.children, (t) => ["OL", "UL"].indexOf(t.nodeName) > -1)
            : null;
        }
        findNextSiblings(t) {
          const e = [];
      ...
      class St {
        ...
        insertTab(t, e) {
          ...
          (t = t.deleteContents()).insertNode(o, !0),
            (t = vt.create(o, e)).select();
        }
        insertParagraph(t, e) {
          e = (e = (e =
            e || vt.create(t)).deleteContents()).wrapBodyInlineWithPara();
              ...
              return void this.bullet.toggleList(o.parentNode.nodeName);
            {
              ...
              if (
                (1 === this.options.blockquoteBreakingLevel
                  ? (t = pt.ancestor(o, pt.isBlockquote))
                  : 2 === this.options.blockquoteBreakingLevel &&
                    (t = pt.lastAncestor(o, pt.isBlockquote)),
                t)
              ) {
                (i = n()(pt.emptyPara)[0]),
                ...
                (t = t.concat(pt.listDescendant(i, pt.isEmptyAnchor))),
                  n.a.each(t, (t, e) => {
                    pt.remove(e);
                  }),
                  (pt.isHeading(i) || pt.isPre(i) || pt.isCustomStyleTag(i)) &&
                    pt.isEmpty(i) &&
                    (i = pt.replace(i, "p"));
              }
            }
      ...
      (It.where = { Row: 0, Column: 1 }),
        (It.requestAction = { Add: 0, Delete: 1 }),
        (It.resultAction = {
          Ignore: 0,
          SubtractSpanCount: 1,
          RemoveCell: 2,
        ...
        addCol(t, e) {
          ...
          for (let t = 0; t < s.length; t++) {
            ...
            switch (o.action) {
              case It.resultAction.AddCell:
                "right" === e
                  ? n()(o.baseCell).after("<td" + i + ">" + pt.blank + "</td>")
                  : n()(o.baseCell).before(
                      "<td" + i + ">" + pt.blank + "</td>"
                    );
                break;
              case It.resultAction.SumSpanCount:
                if ("right" === e) {
                  ...
                  n()(o.baseCell).before("<td" + i + ">" + pt.blank + "</td>");
            }
          }
        }
        recoverAttributes(t) {
            ...
            switch (r[t].action) {
              ...
              case It.resultAction.AddCell:
                ...
                a &&
                  (l > 2
                    ? (l--,
                      c.insertBefore(h, c.cells[i]),
                      c.cells[i].setAttribute("rowSpan", l),
                      (c.cells[i].innerHTML = ""))
                    : 2 === l &&
                      (c.insertBefore(h, c.cells[i]),
                      c.cells[i].removeAttribute("rowSpan"),
                      (c.cells[i].innerHTML = "")));
                continue;
        ...
        options: {
          ...
          modules: {
            editor: class {
              constructor(t) {
                (this.context = t),
                  ...
                  (this.style = new wt()),
                  (this.table = new $t()),
                  (this.typing = new St(t)),
                  (this.bullet = new xt()),
                  (this.history = new yt(this.$editable)),
                ...
                (this.fontName = this.wrapCommand((t) =>
                  this.fontStyling("font-family", f.validFontName(t))
                )),
                  (this.fontSize = this.wrapCommand((t) =>
                    this.fontStyling("font-size", t + "px")
                  ));
                for (let t = 1; t <= 6; t++)
                  (this["formatH" + t] = ((t) => () => {
                ...
                (this.insertParagraph = this.wrapCommand(() => {
                  ...
                  (this.createLink = this.wrapCommand((t) => {
                    ...
                    "string" == typeof e && (e = e.trim()),
                      (e = this.options.onCreateLink
                        ? this.options.onCreateLink(e)
                        : /^([A-Za-z][A-Za-z0-9+-.]*\:|#|\/)/.test(e)
                        ? e
                        : "http://" + e);
                    let l = [];
                    if (a) {
                      const t = (s = s.deleteContents()).insertNode(
                        n()("<A>" + o + "</A>")[0]
                      );
                      l.push(t);
                    } else
                      l = this.style.styleNodes(s, {
                        nodeName: "A",
                    ...
                    n.a.each(l, (t, o) => {
                      n()(o).attr("href", e),
                        i
                          ? n()(o).attr("target", "_blank")
                          : n()(o).removeAttr("target");
                    });
                    const c = vt
                        .createFromNodeBefore(w.head(l))
                        .getStartPoint(),
                      h = vt.createFromNodeAfter(w.last(l)).getEndPoint();
                    vt.create(c.node, c.offset, h.node, h.offset).select(),
                      this.setLastRange();
                  })),
                  ...
                  (this.insertTable = this.wrapCommand((t) => {
                    ...
                    this.getLastRange()
                      .deleteContents()
                      .insertNode(
                        this.table.createTable(e[0], e[1], this.options)
                      );
                  })),
              ...
              initialize() {
                this.$editable
                  .on("keydown", (t) => {
                    if (
                      (t.keyCode === Ct.code.ENTER &&
                        this.context.triggerEvent("enter", t),
                      this.context.triggerEvent("keydown", t),
                      t.isDefaultPrevented() ||
                        (this.options.shortcuts
                          ? this.handleKeyMap(t)
                          : this.preventDefaultEditableShortCuts(t)),
                      this.isLimited(1, t))
                    )
                      return !1;
                  })
                  ...
                  .on("mouseup", (t) => {
                    this.setLastRange(),
                      this.context.triggerEvent("mouseup", t);
                  })
                  .on("scroll", (t) => {
                ...
                return (
                  ...
                  (void 0 === e ||
                    !(
                      ...
                      e.ctrlKey ||
                      e.metaKey ||
                      w.contains([Ct.code.BACKSPACE, Ct.code.DELETE], e.keyCode)
                    )) &&
                    ...
                    this.beforeCommand(),
                      "function" == typeof e
                        ...
                        : ("string" == typeof e && t.attr("data-filename", e),
                          t.css(
                            "width",
                            Math.min(this.$editable.width(), t.width())
                          )),
                      t.show(),
                      vt.create(this.editable).insertNode(t[0]),
                      vt.createFromNodeAfter(t[0]).select(),
                      this.setLastRange(),
                      this.afterCommand();
                  })
                  .fail((t) => {
              ...
              getSelectedText() {
                ...
                return (
                  t.isOnAnchor() &&
                    (t = vt.createFromNode(pt.ancestor(t.sc, pt.isAnchor))),
                  t.toString()
                );
              }
              onFormatBlock(t, e) {
              ...
              fontStyling(t, e) {
                ...
                if (o) {
                  ...
                  if ((n()(i).css(t, e), o.isCollapsed())) {
                    ...
                    t &&
                      !pt.nodeLength(t) &&
                      ((t.innerHTML = pt.ZERO_WIDTH_NBSP_CHAR),
                      vt.createFromNodeAfter(t.firstChild).select(),
                      this.setLastRange(),
                      this.$editable.data(Tt, t));
                  }
                }
              }
              unlink() {
                  ...
                  this.$dropzone
                    .on("dragenter", () => {
                      this.$dropzone.addClass("hover"),
                        e.text(this.lang.image.dropImage);
                    })
                    .on("dragleave", () => {
            ...
            codeview: class {
              ...
              purify(t) {
                if (
                  ...
                  const e = this.options.codeviewIframeWhitelistSrc.concat(
                          ...
                          (o =
                            ...
                            (o =
                              this.options.maxHeight > 0
                                ? Math.min(o, this.options.maxHeight)
                                : o),
            ...
            hintPopover: class {
              ...
              replace() {
                ...
                if (t.length) {
                  ...
                  this.lastWordRange.insertNode(e),
                    vt.createFromNode(e).collapse().select(),
                    (this.lastWordRange = null),
                    this.hide(),
                    this.context.triggerEvent(
                      "change",
              ...
              createItemTemplates(t, e) {
                ...
                return e.map((e, i) => {
                  ...
                  return (
                    s.append(o.template ? o.template(e) : e + ""),
              ...
              createGroup(t, e) {
                ...
                return (
                  this.searchKeyword(t, e, (e) => {
                    (e = e || []).length &&
                      (o.html(this.createItemTemplates(t, e)), this.show());
                  }),
                  o
                );
              }
                  ...
                  if (this.hints.length && e) {
                    ...
                    o &&
                      ...
                      this.hints.forEach((t, o) => {
                        t.match.test(e) &&
                          this.createGroup(o, e).appendTo(this.$content);
                      }),
                      this.$content
            ...
            autoLink: class {
              ...
              handleKeyup(t) {
                w.contains([Ct.code.ENTER, Ct.code.SPACE], t.keyCode) &&
                  this.replace();
              }
            },
            autoSync: class {
                ...
                return (
                  this.fontInstalledMap.hasOwnProperty(t) ||
                    (this.fontInstalledMap[t] =
                      f.isFontInstalled(t) ||
                      w.contains(this.options.fontNamesIgnoreCheck, t)),
                  this.fontInstalledMap[t]
                );
              }
                      ...
                      this.ui.dropdown({
                        ...
                        click: (e) => {
                          ...
                          if ("openPalette" === s) {
                            ...
                            w.contains(["backColor", "foreColor"], s)
                          ) {
                            const t =
                                "backColor" === s
                                  ? "background-color"
                            ...
                            e.css(t, r),
                              o.attr("data-" + s, r),
                              this.context.invoke("editor." + s, r);
                          }
                        },
                      }),
                    ],
              ...
              addToolbarButtons() {
                      ...
                      this.ui.dropdown({
                        ...
                        template: (t) => {
                          "string" == typeof t &&
                            (t = {
                              tag: t,
                              title: this.lang.style.hasOwnProperty(t)
                                ? this.lang.style[t]
                                : t,
                            });
                          const e = t.tag,
                ...
                this.context.memo("button.bold", () =>
                  this.button({
                    ...
                    tooltip:
                      this.lang.font.bold + this.representShortcut("bold"),
                    click:
                ...
                this.context.memo("button.justifyLeft", b.invoke(t, "render")),
                          ...
                          callback: (t) => {
                            t.find(".note-dimension-picker-mousecatcher")
                              .css({
                                ...
                                height:
                                  this.options.insertTableMaxSize.row + "em",
                              })
                              .mousedown(
                                this.context.createInvokeHandler(
                                  "editor.insertTable"
                  ...
                  this.context.memo("button.picture", () =>
                    this.button({
                      ...
                      click:
                        this.context.createInvokeHandler("imageDialog.show"),
                    }).render()
                  ),
                  this.context.memo("button.video", () =>
                    this.button({
                      ...
                      click:
                        this.context.createInvokeHandler("videoDialog.show"),
                    }).render()
                  ),
                  ...
                  this.context.memo("button.help", () =>
                    this.button({
                      ...
                      click:
                        this.context.createInvokeHandler("helpDialog.show"),
                    }).render()
                  );
              }
                ...
                this.context.memo("button.resizeFull", () =>
                  ...
                  this.context.memo("button.removeMedia", () =>
                    this.button({
                      ...
                      click:
                        this.context.createInvokeHandler("editor.removeMedia"),
                    }).render()
                  );
              }
                ...
                if (
                  (this.updateBtnStates(e, {
                    ...
                    ".note-btn-superscript": () =>
                      "superscript" === o["font-superscript"],
            ...
            toolbar: class {
              ...
              followScroll() {
                ...
                this.options.otherStaticBar &&
                  (s = n()(this.options.otherStaticBar).outerHeight());
                  ...
                  this.showLinkDialog(t)
                    .then((t) => {
                      this.context.invoke("editor.restoreRange"),
                        this.context.invoke("editor.createLink", t);
                    })
                    .fail(() => {
                      this.context.invoke("editor.restoreRange");
                    });
                ...
                if (this.options.maximumImageFileSize) {
                  const t = Math.floor(
                    ...
                    o =
                      1 *
                        (
                          this.options.maximumImageFileSize / Math.pow(1024, t)
                        ).toFixed(2) +
                      " " +
                      " KMGTP"[t] +
                      "B";
              ...
              createVideoNode(t) {
                ...
                if (o && 11 === o[1].length) {
                  ...
                  if (void 0 !== o[2]) {
                    ...
                    if (t)
                      for (
                        var b = [3600, 60, 1], v = 0, k = b.length;
                        v < k;
                        v++
                      )
                        g +=
                          void 0 !== t[v + 1]
                            ? b[v] * parseInt(t[v + 1], 10)
                            : 0;
                  }
                  f = n()("<iframe>")
                    .attr("frameborder", 0)
            ...
            airPopover: class {
              ...
              shouldInitialize() {
                return (
                  this.options.airMode && !w.isEmpty(this.options.popover.air)
                );
              }
              initialize() {
                this.$popover = this.ui
    ...
    51: function (t, e, o) {
      ...
      const r = s.a.create(
        ...
        w = {
          ...
          createLayout: function (t, e) {
            const o = (
              e.airMode
                ? w.airEditor([w.editingArea([w.airEditable()])])
                : w.editor([
                    w.toolbar(),
                    w.editingArea([w.codable(), w.editable()]),
                    w.statusbar(),
                  ])
            ).render();
            return (
      ...
      var x = w;
      o(3), o(4);
      n.a.summernote = n.a.extend(n.a.summernote, { ui: x });
    },
  });
});
